...
Nesta exemplo (versão atualizada aqui: https://rpubs.com/darren75/lourenco) aprenderemos sobre como analisar a cobertura da terra com métricas de paisagem em R.
...
digits = meu_digits) %>% 
kableExtra::kable_styling() %>% 
kableExtra::save_kable("data/tabela_metricas_1985.html")
```
...
Uma forma alternativa de visualização entre anos seria um diagrama "Sankey"/"Alluvial". Como exemplo, veja figura 3 no artigo "Rapid land use conversion in the Cerrado has affected water transparency in a hotspot of ecotourism, Bonito, Brazil" https://doi.org/10.1177/194008292211270 . 
